  ...
  <div id='UsersManage'  class='UsersManage'>
         <el-card shadow="always" :body-style="{ padding: '10px' }">
             <div slot="header">
                ...
                </el-input> <el-button type="primary" size="small" icon="el-icon-plus" @click="createUserShow">添加用户</el-button>
                </el-input> <el-button type="danger" size="small" icon="el-icon-delete" @click="deleteByIdList" :disabled="deleteEnable">批量删除</el-button>
               ...
               border stripe >
                <el-table-column type="selection" width="55">  </el-table-column>
                  ...
                  <el-table-column   prop="roleName" label="权限列表" >
                      <template slot-scope= '{row,index}' v-if="row.roleName !== ''">
